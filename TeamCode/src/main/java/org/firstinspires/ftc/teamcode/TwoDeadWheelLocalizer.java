...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1259.330238045658; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2195.0808098477346; // x position of the perpendicular encoder (in tick units)
    }
