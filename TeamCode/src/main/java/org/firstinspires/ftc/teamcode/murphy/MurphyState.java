 ...
 * This should be done using a 'MurphyStateMachine'.
...
public interface MurphyState {
    /**
     * This is called every frame by the 'MurphyStateMachine' to run the state.
     ...
     * This is used by the 'MurphyStateMachine' to print the current state name.
